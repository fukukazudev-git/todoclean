...
-- 列: title, description, done(完了フラグ), opt_lock_version(楽観ロック用=0), created_at(NOT NULL), due_date

-- 未完了・期限が近い
INSERT INTO todo_entity (title, description, done, opt_lock_version, created_at, due_date)
